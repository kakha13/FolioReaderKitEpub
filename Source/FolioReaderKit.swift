...
extension FolioReader {
    ...
    @objc open func openReader(withPath epubPath: String, andParentViewController parentViewController: UIViewController) {
        let config = FolioReaderConfig()
        self.presentReader(parentViewController: parentViewController, withEpubPath: epubPath, andConfig: config)
    }

    @objc open func presentReader(parentViewController: UIViewController, withEpubPath epubPath: String, andConfig config: FolioReaderConfig, shouldRemoveEpub: Bool = true, animated: Bool = true) {
        self.presentReader(parentViewController: parentViewController, withEpubPath: epubPath, unzipPath: nil, andConfig: config, shouldRemoveEpub: shouldRemoveEpub, animated: animated)
    }
}
